...
//   const navigate = useNavigate();
  ...
  const handleCheckbox = (e) => {
    ...
    if (isChecked) {
      ...
      let _filteredArray = _tempArray.filter((genre) => genre !== e.target.value);
  ...
  useEffect(() => {
    ...
    return ( 
        ...
        <FormWrapper onSubmit={(e) => handleSubmit(e)}>
            ...
            {bannerCounter && bannerCounter.map((element, index) => (
                <BannerWrapper key={index} >
                <BannerInput handleBanner={handleBanner}/>
                <BannerButton type="button" onClick={handleAddBanner}>+</BannerButton>
                </BannerWrapper>
            ))}
